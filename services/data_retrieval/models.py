...
class TweetModel(BaseModel):
    ...
    createdate: datetime = Field(..., alias="CreateDate", description="Original creation date")
    antisemietic: int = Field(..., alias="Antisemitic", description="0 or 1 - antisemitic classification")
    ...
    weapons_detected: List[str] = Field(default=[], description="List of detected weapons")
