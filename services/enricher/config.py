...
KAFKA_TOPIC_IN_ANTISEMITIC = os.getenv("KAFKA_TOPIC_IN_ANTISEMITIC", "preprocessed_tweets_antisemitic")
KAFKA_TOPIC_IN_NOT_ANTISEMITIC = os.getenv("KAFKA_TOPIC_IN_NOT_ANTISEMITIC", "preprocessed_tweets_not_antisemitic")

# Output topics - where processed tweets are sent to
KAFKA_TOPIC_OUT_ANTISEMITIC = os.getenv("KAFKA_TOPIC_OUT_ANTISEMITIC", "enriched_preprocessed_tweets_antisemitic")
KAFKA_TOPIC_OUT_NOT_ANTISEMITIC = os.getenv("KAFKA_TOPIC_OUT_NOT_ANTISEMITIC", "enriched_preprocessed_tweets_not_antisemitic")

# Processing configuration
TARGET_ORIGINAL = os.getenv("TARGET_KEY", "text")  # Key name for text content in tweet messages
TARGET_PROCESSED = os.getenv("TARGET_PROCESSED_KEY", "clean_text")  # Key name for cleaned text
